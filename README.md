...
7. 菜单提供使用帮助与隐私说明；二级页面顶部左箭头返回主菜单、右上角×关闭菜单，正文可滚动，底部不再重复显示退出操作。翻译设置、账号、订阅标为暂不可用。本版无需登录。点“× 关闭”，或主菜单/首页的“关闭放大镜”，关闭共享及所有悬浮窗口。**锁屏后再解锁，放大窗消失是正常行为**；需要时回到看懂再点“打开放大镜”，重新确认本次屏幕共享。旋转后同样停止。
